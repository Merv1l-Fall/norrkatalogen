import Joi from "joi";
import type { NewCompanyFormData } from "@/types";

const companySchema: Joi.ObjectSchema<NewCompanyFormData> = Joi.object({
  ...
  contactPhone: Joi.string()
    ...
    .messages({
      "string.pattern.base":
        "Telefonnummer måste vara mellan 6 och 15 tecken och kan innehålla siffror, plus, bindestreck och mellanslag.",
